  ...
  return (
    <div className="rounded-xl border border-border bg-card shadow-sm">
      <div className="border-b border-border px-5 py-4">
        ...
        <p className="text-xs text-muted-foreground">Last 10 events across clients</p>
      </div>
        ...
        {events.length === 0 ? (
          ...
          events.map((e) => {
            ...
            return (
              ...
              >
                <div className={cn("rounded-lg bg-muted p-2", config.className)}>
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">{formatTime(e.occurred_at)}</p>
                </div>
              </div>
            );
          })
